...
| 编号 | 子智能体 | 角色 | 权限 |
|:----:|---------|------|------|
| 1 | `research-planner` | 🧑‍💼 规划师 | 纯推理 |
| 2 | `research-executor` | 🔍 检索员 | web_search, web_fetch, tavily, exa, scholar, article, scholarly, playwright |
| 3 | `research-analyst` | 📊 分析师 | 纯推理 |
| 4 | `research-writer` | ✍️ 撰稿人 | 纯生成 |
| 5 | `research-reviewer` | ✅ 审核员 | 纯校验 |
| — | `phd-proposal-writer` | 🎓 博士计划撰写 | web_search, scholar, tavily |
| — | `stats-assistant` | 📊 生物统计建模 | coderunner, web_search, scholar |
| — | `stats-method-finder` | 🔍 方法扩充 | web_search, scholar, web_fetch |
| — | `paper-analyzer` | 📖 论文解析 | web_fetch, scholar |
| — | `frontier-tracker` | 🔭 前沿追踪 | web_search, scholar, article, web_fetch |
