...
| 📖 Data Provenance | ✅ | Full source traceability: `data/reports/FISH_DATABASES_GUIDE.md` |
...
本项目已集成 [eon-core/shared/rcca_core.py](https://github.com/fangtaocai041/eon-core) 的便携 RCCA 核心模块（三生万物硅基生命体架构的便携版本）。
