...
| **coilia-agent** | **衍生 P₁** | 刀鲚专?| 耳石微化學· 洄游生?|
...
**📖 知识是暂时的** ?科学精神的基石是证伪主义（Popper）。没有发现是终极真理，只?当前最佳解?。我们使用校准语言——说"证据表明"而不?证明?，说"Smith(2022) 发现"而不是「研究表明」"。每一个输出都标注时间锚点?
...
| 异常?| 忽略，当噪声 | ? 独立来源 ?涌现信号，主动追蹤 |
| 知识过期 | 手册写死不再更新 | 验证记录?下次复查日期"，按包活跃度动态计?|
| 方法选择 | 固定方法用到底 | 动态选择，置信度动态计?|
...
集成了**21 個 MCP 工具**?*28 个领域技?*?*12 引擎并行搜索**、自动化?**5 阶段研究流水?*?*13 ?IMA 知识?*，以及**R 统计计算环境**——所有输出都遵循上述双核哲学?
### 📊 能力清单
